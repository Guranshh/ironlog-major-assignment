...
export const posts: Post[] = [
  ...
  {
    id: 5,
    title: "Scaling MongoDB for production",
    urlId: "scaling-mongodb-for-production",
    description,
  ...
  {
    id: 6,
    title: "CI pipelines that do not fight you",
    urlId: "ci-pipelines-that-do-not-fight-you",
    description,
    content: content + " ... post6",
    imageUrl:
      "https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?w=500&auto=format&fit=crop&q=60",
    date: new Date("Aug 02, 2023"),
    category: "DevOps",
